  ...
  return (
    ...
    >
      ...
      <div className="relative px-4 lg:px-36 w-full">
        ...
        <motion.h1
          className="text-5xl lg:text-6xl font-roboto-flex mb-6 font-semibold text-wrap"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
        ...
        <motion.h1
          className="text-5xl lg:text-5xl font-roboto-flex mb-6 font-semibold text-wrap"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
        ...
        <motion.p
          className="text-lg lg:text-2xl mb-4 font-lora "
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
