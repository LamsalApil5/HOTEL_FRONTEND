...
const testimonials = [
  {
    name: "Ethan",
    content:
      "A delightful choice in the charming town of Marpha. A quiet night’s rest in a clean room with delicious food and a most welcoming and kind family. Also, don’t miss the homemade treats, such as the jams, juices, wines, ciders and brandy (especially the apricot one). Oh and there's an espresso machine!",
    image: google ,
  },
  {
    name: "Dinesh Giri",
  ...
  return (
    <section className="py-8 md:py-20 bg-none ">
      <div className="container px-4">
        <h2 className="text-3xl font-roboto-flex text-center mb-8">
        ...
        <div className="flex items-center justify-center">
          <Button
            ...
            className="mr-4 bg-none border-none"
          >
          ...
          <Button
            ...
            className="ml-4 bg-none border-none"
          >
